...
class TimerTask:
    ...
    def __init__(self):
        TimerTask.__all_timers.append(self)

    def init(self, mode=PERIODIC, freq=-1, period=-1, timeout=DEFAULT_TIMEOUT_MS):
    ...
    def get_all_timer_task():
        return iter(TimerTask.__all_timers)

    @staticmethod
    def pause_all():
        for tim in TimerTask.get_all_timer_task():
            tim.running = True
